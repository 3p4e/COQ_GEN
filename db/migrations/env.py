"""Alembic environment — online migrations against COQGEN_DATABASE_URL (sync psycopg)."""
...
DB_URL = os.environ.get("COQGEN_DATABASE_URL") or config.get_main_option("sqlalchemy.url")
